  ...
  >
    ...
    <script type="module">
      ...
      try {
        ...
        console.log("%c📊 Analytics enabled", "color: blue");
        console.log("%c🔒 Using secure artifacts path", "color: blue");
      } catch (e) {
        console.warn(
          "%c⚠️ Running in DEMO MODE (Offline)",
        ...
        db = {
          ...
          addDoc: async (col, data) => {
            console.log("📝 Demo Firestore Write:", data);
      ...
      const state = {
        ...
        messages: [
          {
            role: "bot",
            text: `👋 Hello! I'm your AI Assistant from The IAH Creations, powered by Gemini 2.0 Flash.\\n\\nI can help you with:\\n• **Prompt-to-App**: Describe your app, I'll generate code!\\n• Template recommendations (Mobile/Web/Website)\\n• Pricing \\u0026 payment options\\n• Deployment assistance\\n\\n💼 Virtual Business Card: ${BUSINESS_CARD_URL}\\n\\nWhat would you like to create today?`,
          },
        ],
      };
      ...
      const FreemiumModel = {
        ...
        showUpgradeModal() {
          showToast("⭐ Upgrade to Pro for unlimited access!", "error");
      ...
      const AIHub = {
        ...
        setApiKey(key) {
          ...
          console.log("%c✅ AI API key configured", "color: green");
        },

        async generate(prompt, context = "") {
          if (!this.apiKey) {
            return "🔑 Please configure your Gemini API key to use the AI chatbot.";
          }

          try {
            console.log(`🤖 AIHub (${this.model}): Generating response...`);
      ...
      - Custom Web Development starting at ₹4,999
      ...
      Be helpful, professional, and guide users toward our services when appropriate.`;
            ...
            console.log("%c✅ AI Response generated", "color: green");
      ...
      const GlobalizationHub = {
        ...
        changeLanguage(lang) {
          ...
          if (isRTL) {
            console.log(`%c🌐 RTL mode activated for ${lang}`, "color: purple");
          }
      ...
      const VoiceEngine = {
        ...
        init() {
          ...
          if (SpeechRecognition) {
            ...
            console.log("%c🎤 Voice recognition initialized", "color: purple");
          } else {
      ...
      const PaymentHub = {
        ...
        razorpay: {
          ...
          async processPayment(amount, currency = "INR") {
            console.log("💳 Razorpay payment:", amount, currency);
        ...
        crypto: {
          ...
          async generatePaymentAddress(coin, amount) {
            console.log(`₿ Crypto payment: ${amount} ${coin}`);
            return {
        ...
        async processPayment(templateId, method = "upi") {
          ...
          switch (method) {
            ...
            case "crypto":
              ...
              showToast(`₿ Send ${payment.amount} to wallet`);
              break;
          }
        },
      ...
      const PromptToAppHub = {
        async generateApp(description, type = "website") {
          ...
          try {
            console.log(`🚀 Generating ${type} from prompt...`);
      ...
      Generate ONLY the code, no explanations.`;
        ...
        async deployCode(code, platform = "firebase") {
          ...
          showToast(`🚀 Deployment to ${platform} initiated!`);
      ...
      const BlockchainHub = {
        ...
        async registerOwnership(code, userId) {
          if (!FreemiumModel.checkAccess("blockchain")) {
            console.log("⛓️ Blockchain protection requires Pro/Enterprise");
            return false;
          }

          try {
            const hash = await this.hashCode(code);
            console.log(`⛓️ Registering code ownership: ${hash}`);
            ...
            showToast("⛓️ Code registered on blockchain!");
            return certificate;
          } catch (error) {
        ...
        async verifyOwnership(code, userId) {
          const hash = await this.hashCode(code);
          console.log(`⛓️ Verifying ownership for hash: ${hash}`);
        ...
        darkWebMonitoring: {
          ...
          async scanForTheft(codeHash) {
            if (!FreemiumModel.checkAccess("darkWeb")) {
              console.log("🕵️ Dark web monitoring requires Enterprise plan");
              return null;
            }

            console.log("🕵️ Scanning dark web for stolen code...");
          ...
          startMonitoring(codeHash) {
            console.log(
              `🕵️ Started continuous monitoring for: ${codeHash.substring(
                0,
                16
              )}...`
            );
      ...
      const AutoUpdateHub = {
        ...
        async checkForUpdates() {
          try {
            ...
            console.log(
              "%c⚠ Update check failed silently",
              "color: gray; font-size: 10px"
            );
          }
        },
                      ...
                      <div class="holographic-card rounded-xl overflow-hidden hover:scale-105 transition-transform">
                        ...
                        <div class="p-6">
                          <div class="flex justify-between items-start mb-2">
                            ...
                            ${
                              t.rating
                                ? `<span class="text-yellow-400">⭐ ${t.rating}</span>`
                                : ""
                            }
                          </div>
                          ...
                          <ul class="space-y-1 mb-4">
                            ${t.features
                              ...
                              .map(
                                (f) => `
                              <li class="text-sm text-gray-300">✓ ${f}</li>
                            `
                              )
                              .join("")}
                          </ul>
                    ...
                    ${
                      ...
                      <div class="mt-8 p-6 bg-gray-900 rounded-lg border border-green-500">
                        <div class="flex justify-between items-center mb-4">
                          <h3 class="text-xl font-bold text-white">✅ Code Generated!</h3>
        ...
        return `
                <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-fade-in">
                  <div class="bg-gray-900 border border-blue-500 rounded-2xl max-w-md w-full overflow-hidden shadow-2xl relative">
                    <button onclick="closePaymentModal()" class="absolute top-4 right-4 text-gray-400 hover:text-white">✕</button>
                  ...
                  <div class="holographic-card p-8 rounded-xl space-y-6">
                    ...
                    <section>
                      ...
                      <ul class="space-y-2 text-gray-300">
                        <li>✓ Powered by Google Gemini 2.0 Flash AI</li>
                        <li>✓ Multi-database support (Firebase, Cloud SQL, BigQuery, Spanner, Bigtable)</li>
                        <li>✓ 20+ language support with RTL capabilities</li>
                        <li>✓ Voice recognition and synthesis</li>
                        <li>✓ Blockchain-based code protection</li>
                      </ul>
                    </section>
                    <section>
      ...
      // ============================================
      console.log(
        `%c🚀 The IAH Creations Platform v${APP_VERSION}`,
        "color: #3b82f6; font-size: 20px; font-weight: bold"
      );
      console.log("%c✅ All systems operational", "color: green");
      console.log(
        `%c🤖 Gemini AI: ${AIHub.apiKey ? "Configured" : "Not configured"}`,
        AIHub.apiKey ? "color: green" : "color: orange"
      );
      console.log(
        `%c🔒 Firebase: ${isFirebaseReady ? "Connected" : "Demo mode"}`,
      ...
      if (auth && typeof auth.onAuthStateChanged === "function") {
        auth.onAuthStateChanged((user) => {
          ...
          if (user) {
            console.log("%c👤 User authenticated:", "color: green", user.uid);
          }
        });
